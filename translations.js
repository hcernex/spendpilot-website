...
const translations = {
    fr: {
        ...
        "solution.subtitle": "En quelques minutes, notre outil scanne automatiquement votre infrastructure AWS, Azure ou GCP et génère un rapport complet des optimisations possibles.",
        "solution.step1.title": "Connexion sécurisée",
        "solution.step1.desc": "Accès en lecture seule à votre tenant via AWS, Azure ou GCP APIs. Installation en moins de 30 minutes, aucun changement d'infrastructure.",
        ...
        "features.gcp": "GCP",
        "features.gcp.desc": "Google Cloud : BigQuery, Compute Engine, Cloud Storage, Recommender",
        ...
        // Scoring
        "scoring.tag": "Scoring intelligent",
        "scoring.title.part1": "Mesurez votre performance avec les scores",
        "scoring.title.part2": "FinOps & GreenOps",
        "scoring.subtitle": "Deux indicateurs clés pour piloter votre optimisation Cloud et réduire votre empreinte carbone.",
        "scoring.finops.label": "Score FinOps",
        "scoring.finops.desc": "Mesure l'efficacité de votre optimisation des coûts. Analyse le ratio gaspillage/dépenses totales, pondéré par la sévérité des problèmes détectés.",
        "scoring.finops.metric1": "Compute, Storage, Network, Database",
        "scoring.finops.metric2": "VMs surdimensionnées (CPU < 20%)",
        "scoring.finops.metric3": "Disques et IPs orphelins",
        "scoring.finops.metric4": "Reserved Instances non utilisées",
        "scoring.greenops.label": "Score GreenOps",
        "scoring.greenops.desc": "Mesure l'efficacité carbone de votre infrastructure. Bonus pour les régions renouvelables (AWS: Irlande, Oregon ; Azure: Suède, Norvège).",
        "scoring.greenops.metric1": "Intensité carbone par région",
        "scoring.greenops.metric2": "Utilisation énergies renouvelables",
        "scoring.greenops.metric3": "Ressources zombies énergivores",
        "scoring.greenops.metric4": "Instances anciennes génération",
        "scoring.health.label": "Note globale",
        "scoring.health.desc": "Combinaison pondérée : 60% FinOps + 40% GreenOps. Suivez vos progrès dans le temps avec des graphiques d'évolution.",
        "scoring.health.metric1": "Dashboard exécutif temps réel",
        "scoring.health.metric2": "Historique et tendances",
        "scoring.health.metric3": "Alertes et notifications",
        "scoring.health.metric4": "Export PDF pour COMEX",
        ...
        // Footer
        "footer.tagline": "Optimisation des coûts Cloud. FinOps & GreenOps pour AWS, Azure et GCP.",
        ...
        "contact.subtitle": "En quelques heures, vous saurez exactement combien vous pouvez économiser sur votre infrastructure Cloud AWS, Azure ou GCP.",
        ...
        "faq.q1.answer": "Nous connectons SpendPilot à votre tenant AWS, Azure ou GCP en lecture seule. Notre outil analyse automatiquement vos ressources et génère un rapport complet des économies possibles en 48h.",
        ...
        "form.provider.gcp": "Google Cloud Platform (GCP)",
        "form.provider.multi": "Multi-cloud (AWS, Azure, GCP)",
        ...
        "blog.subtitle": "Découvrez nos articles sur l'optimisation des coûts Cloud, les bonnes pratiques FinOps et les stratégies GreenOps pour AWS, Azure et GCP.",
    ...
    en: {
        ...
        "solution.subtitle": "In minutes, our tool automatically scans your AWS, Azure or GCP infrastructure and generates a complete optimization report.",
        "solution.step1.title": "Secure connection",
        "solution.step1.desc": "Read-only access to your tenant via AWS, Azure or GCP APIs. Setup in under 30 minutes, no infrastructure changes.",
        "solution.step1.time": "30 min",
        ...
        // Scoring
        "scoring.tag": "Smart Scoring",
        "scoring.title.part1": "Measure your performance with",
        "scoring.title.part2": "FinOps & GreenOps scores",
        "scoring.subtitle": "Two key indicators to drive your Cloud optimization and reduce your carbon footprint.",
        "scoring.finops.label": "FinOps Score",
        "scoring.finops.desc": "Measures your cost optimization efficiency. Analyzes the waste/total spending ratio, weighted by the severity of detected issues.",
        "scoring.finops.metric1": "Compute, Storage, Network, Database",
        "scoring.finops.metric2": "Oversized VMs (CPU < 20%)",
        "scoring.finops.metric3": "Orphan disks and IPs",
        "scoring.finops.metric4": "Unused Reserved Instances",
        "scoring.greenops.label": "GreenOps Score",
        "scoring.greenops.desc": "Measures your infrastructure's carbon efficiency. Bonus for renewable regions (AWS: Ireland, Oregon; Azure: Sweden, Norway).",
        "scoring.greenops.metric1": "Carbon intensity by region",
        "scoring.greenops.metric2": "Renewable energy usage",
        "scoring.greenops.metric3": "Energy-consuming zombie resources",
        "scoring.greenops.metric4": "Legacy generation instances",
        "scoring.health.label": "Overall Grade",
        "scoring.health.desc": "Weighted combination: 60% FinOps + 40% GreenOps. Track your progress over time with evolution charts.",
        "scoring.health.metric1": "Real-time executive dashboard",
        "scoring.health.metric2": "History and trends",
        "scoring.health.metric3": "Alerts and notifications",
        "scoring.health.metric4": "PDF export for board meetings",
        ...
        // Footer
        "footer.tagline": "Cloud cost optimization. FinOps & GreenOps for AWS, Azure and GCP.",
        "footer.navigation": "Navigation",
        ...
        "contact.subtitle": "In a few hours, you'll know exactly how much you can save on your AWS, Azure or GCP Cloud infrastructure.",
        "contact.email.label": "Email",
        ...
        "faq.q1.answer": "We connect SpendPilot to your AWS, Azure or GCP tenant in read-only mode. Our tool automatically analyzes your resources and generates a complete savings report within 48 hours.",
        ...
        "blog.subtitle": "Discover our articles on Cloud cost optimization, FinOps best practices, and GreenOps strategies for AWS, Azure and GCP.",
        "blog.category.finops": "FinOps",
        "blog.category.azure": "Azure",
        "blog.category.aws": "AWS",
        "blog.category.greenops": "GreenOps",
